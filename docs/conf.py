...
project = 'db Reporting Tool'
copyright = '2017, Michael Scales'
...
htmlhelp_basename = 'dbReportingTooldoc'
...
latex_documents = [
    (master_doc, 'dbReportingTool.tex', 'db Reporting Tool Documentation',
     'Michael Scales', 'manual'),
]
...
man_pages = [
    (master_doc, 'dbreportingtool', 'db Reporting Tool Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dbReportingTool', 'db Reporting Tool Documentation',
     author, 'dbReportingTool', 'One line description of project.',
     'Miscellaneous'),
]
